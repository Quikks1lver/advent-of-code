...
# Returns num paper accessed and locations of those papers.
def part1(input: List[List[str]]) -> Tuple[int, List[Tuple[int, int]]]:
    total = 0
    ...
    return (total, accessible_papers)
...
def main() -> None:
    ...
    # Part1 function is used in Part2, so just 'hacking around' my printing system here. No timing p1 today!
    p1_ans = part1(input)[0]
    PART1(lambda x : p1_ans, input)
    PART2(part2, input)
